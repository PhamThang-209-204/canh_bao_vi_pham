...
<img src="Logo_DAI_NAM.png" alt="Đại học Đại Nam Logo" width="150"/>
...
<div align="center">
  <img src="poster.jpg" alt="Poster dự án" width="500" style="border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.15); margin: 20px 0;">
</div>
...
| [Web3.py](https://web3py.readthedocs.io/) | 6<div align="center">
...
Made with ❤️ by Phạm Thắng.x | Giao tiếp với Smart Contract (Blockchain) |
| [Solidity](https://soliditylang.org/) | ^0.8.0 | Viết Smart Contract |
...
Bước 1: Clone Repository
Bashgit clone https://github.com/PhamThang-209-204/canh_bao_vi_pham.git
cd canh_bao_vi_pham
Bước 2: Tạo Virtual Environment
Bash# Windows
python -m venv .venv
...
🚀 Sử Dụng
1. Hiệu Chuẩn Camera (Calibrate)
Bashpython calibrate.py --video input_video.mp4 --frame 100
2. Chạy Web Dashboard
Bashpython app.py
Sau đó mở trình duyệt: http://127.0.0.1:5000
📖 Tài Liệu Cốt Lõi
Nguyên Lý Tính Tốc Độ (Perspective Transform)
Hệ thống sử dụng ma trận Homography để chuyển đổi không gian 2D sang không gian phẳng (đơn vị mét) nhằm tính tốc độ chính xác.
...
Fork repository.
Tạo branch (git checkout -b feature/AmazingFeature).
